      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            ...
            asimple idea: to provide a platform where customers can easily
            discover,explore, and purchase a wide range of products from the
            comfort of their homes.
          </p>
          <p>
            Since our inception, we've worked tirelessly to create a diverse
            selection of high-quality products that cater to every fast and
            preference. From fashion and beauty to electronics essentials, we
          ...
          <p>
            ...
            shopping experience that exceeds expactations,from browsing and
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20">
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">
            We meticulously slect and vet each product to ensure it meets our
